...
1. Decoupled the point number. **_PUDM V2_** conducts upsampling based on the point number, not the upsampling rate. For example, the output (S,3), S can be any positive integer. This means that PUDM V2 is also able to perform downsampling. <br/>
